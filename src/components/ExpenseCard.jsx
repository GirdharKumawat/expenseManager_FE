import { CreditCard, Trash2, Package } from "lucide-react";
...
const ExpenseCard = ({ expense, onDelete }) => {
    const { amount, category, description, date, paymentType } = expense;
    ...
    return (
        <div className="group relative transition-all duration-300 transform hover:-translate-y-0.5">
            <div className="flex w-full items-center justify-between rounded-2xl border border-slate-200/80 bg-white/95 p-4 shadow-xs backdrop-blur-md transition-all hover:border-emerald-500/40 hover:shadow-card-hover">
                ...
                <div className="flex items-center space-x-3 shrink-0">
                    ...
                    <button
                        ...
                        className="rounded-xl border border-slate-200/80 bg-slate-50 p-2 text-slate-400 transition-all hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 active:scale-95"
